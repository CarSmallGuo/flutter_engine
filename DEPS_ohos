...
vars = {
  ...
  'dart_boringssl_gen_rev': '8155fae45b086fe0ac52f3f63256113c1fa8da7e',
...
deps = {
  ...
  'src/flutter/third_party/boringssl':
   Var('ohos_git') + '/fluttertpc_boringssl_gen.git' + '@' + Var('dart_boringssl_gen_rev'),
  ...
  'src/flutter/third_party/pyyaml':
   ...
   Var('ohos_git') + '/fluttertpc_swiftshader.git' + '@' + '235941e4b36c2a3d143d37e9e3c6c3a31e9a9501',
