...
void OhosTouchProcessor::HandlePinchEvent(
  ...
  // 生成两个模拟触摸事件
  OH_NativeXComponent_TouchEvent* touchEvent1 = new OH_NativeXComponent_TouchEvent();
  OH_NativeXComponent_TouchEvent* touchEvent2 = new OH_NativeXComponent_TouchEvent();
...
void OhosTouchProcessor::HandleFlingEvent(
  ...
  // 生成模拟触摸事件
  OH_NativeXComponent_TouchEvent* touchEvent = new OH_NativeXComponent_TouchEvent();
