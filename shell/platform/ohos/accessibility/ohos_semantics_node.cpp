...
void SemanticsNodeExtend::OHOSActionsUpdate() {
  ...
  // node.
  // update: Now we will send showOnScreen action to bring the focused node on screen
  // entirely so the node can gain focus no matter whether the node is visible.
