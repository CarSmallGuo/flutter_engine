...
namespace hiappevent{
    ...
    void OhosHiappEventDDL::apiGet(void)
    {
        ...
        do {
            createProcessorFunc_ = reinterpret_cast<CreateProcessorFunc>(dlsym(libhiappevent_ndk_handler_, 
            ...
            setReportRouteFunc_ = reinterpret_cast<SetReportRouteFunc>(dlsym(libhiappevent_ndk_handler_, 
            ...
            setReportPoliceFunc_ = reinterpret_cast<SetReportPoliceFunc>(dlsym(libhiappevent_ndk_handler_, 
            ...
            setReportEventFunc_ = reinterpret_cast<SetReportEventFunc>(dlsym(libhiappevent_ndk_handler_, 
            ...
            addFunc_ = reinterpret_cast<AddFunc>(dlsym(libhiappevent_ndk_handler_, 
            ...
            addStringParam_ = reinterpret_cast<AddStringParam>(dlsym(libhiappevent_ndk_handler_, 
            ...
            addInt32Param_ = reinterpret_cast<AddInt32Param>(dlsym(libhiappevent_ndk_handler_,
            ...
            addInt64Param_ = reinterpret_cast<AddInt64Param>(dlsym(libhiappevent_ndk_handler_, 
            ...
            write_ = reinterpret_cast<Write>(dlsym(libhiappevent_ndk_handler_, 
                "OH_HiAppEvent_Write"));
            if (write_ == nullptr) {
            ...
            destroyParamList_ = reinterpret_cast<DestroyParamList>(dlsym(libhiappevent_ndk_handler_, 
            ...
            destroyProcessor_ = reinterpret_cast<DestroyProcessor>(dlsym(libhiappevent_ndk_handler_, 
