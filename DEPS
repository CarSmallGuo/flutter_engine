...
vars = {
  ...
  # dart_revision is used to download the dart toolchain used on host
  # ohos_dart_revision is used to download the dart sdk compiled for engine
  'ohos_dart_revision': '6fa23e447ced07a3f49470a7c293bc42b69f7cd5',
...
deps = {
  'src': Var('ohos_git') + '/fluttertpc_buildroot.git' + '@' + 'f7a3cbc1e23da5056ebf2fe7599ffc1e46797ec6',
  ...
  'src/third_party/dart':
   Var('ohos_git') + '/fluttertpc_dart_sdk.git' + '@' + Var('ohos_dart_revision'),
